...
export default function Card(props: {
    ...
    return (
        <div className="flex-none w-2/3 mr-8 border rounded-lg md:w-1/3 md:pb-4">
            <div className="relative overflow-hidden rounded">

                <img className="w-full rounded-lg" src={require(`./images/${props.coverImg}`)} alt={props.title} />
